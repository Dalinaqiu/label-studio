        ...
        {loaded && backends.length === 0 && (
          <SimpleCard title="" className="bg-primary-background border-primary-border-subtler p-base">
            <EmptyState
              ...
              icon={<IconModels />}
              title="连接你的第一个模型"
              description="连接机器学习模型，为项目生成实时预测。对比预测结果，通过自动预标注加速标注，并通过主动学习将团队聚焦到最有价值的任务。"
              actions={
                <Button
                  variant="primary"
                  look="filled"
            ...
            <div className="p-wide border border-neutral-border rounded-md">
              <Form.Row columnCount={1}>
                ...
                <div>
                  <Toggle
                    label="提交标注时启动模型训练"
                    description="该选项会向 /train 发送包含标注信息的请求，可用于启用主动学习闭环。也可以在模型卡片的菜单中手动启动训练。"
