...
export const gcsProvider: ProviderConfig = {
  name: "gcs",
  title: "Google Cloud Storage 存储",
  description: "配置你的 Google Cloud Storage 连接以及所需的 Label Studio 设置",
  ...
  fields: [
    ...
    },
    {
      ...
      type: "password",
      label: "Google 应用凭据",
      description: "在此粘贴 credentials.json 内容，或留空以使用 ADC。",
    ...
    },
    {
      ...
      description:
        "启用预签名 URL 后，数据不经过平台，浏览器将直接从存储读取数据",
